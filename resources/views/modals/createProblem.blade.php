<div id="createProblem" class="createProblem hidden w-full h-full bg-black/80 z-50 flex items-start justify-center fixed left-0 top-0">
    <form enctype="multipart/form-data" method="POST" class="relative bg-white p-10 mt-20 rounded-lg w-[40%] flex flex-col gap-5 items-center justify-center" action="{{ secure_url('createProblem') }}">
        @csrf
